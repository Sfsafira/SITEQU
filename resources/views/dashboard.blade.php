                        ...
                        <div class="card">
                            <div class="card-body bg-info text-center">
                                <small class="font-weight-bolder" style="font-size: 18px !important">SELAMAT DATANG DI SISTEM
                                    MANAJEMEN INFORMASI AL-QURAN</small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="/browsing" class="btn btn-primary float-right">Akses Sekarang</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="/searching" class="btn btn-primary float-right">Akses Sekarang</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-primary float-right" onclick="kuesioner()">Akses Sekarang</>
                        </div>
                    </div>
                </div>
            </div>
